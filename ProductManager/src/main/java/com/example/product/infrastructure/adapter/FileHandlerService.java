...
public class FileHandlerService {
  ...
  /**
   * Uploads an image file to a Blob storage using FileHandler service. Applies retry and circuit
   * breaker policies for resilience.
   *
  ...
  public UUID uploadImageToBlob(MultipartFile image) {
    ...
    ResponseEntity<UUID> responseEntity = restTemplate.postForEntity(url, requestEntity,
        UUID.class);
